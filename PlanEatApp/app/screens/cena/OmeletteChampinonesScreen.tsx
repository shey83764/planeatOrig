...
export default function OmeletteChampinonesScreen() {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Omelette de champiñones</Text>

      <Text style={styles.subtitle}>Alimentos:</Text>
      <Text>• Huevo 2 un</Text>
      <Text>• Clara extra 1 u</Text>
      <Text>• Champiñones 80 g</Text>
      <Text>• Aceite 5 g</Text>
      <Text>• Pan integral 30 g</Text>

      <Text style={styles.subtitle}>Procedimiento:</Text>
      <Text>1. Saltear champiñones.</Text>
      <Text>2. Añadir huevos batidos y formar omelette.</Text>
      <Text>3. Servir con pan.</Text>
      ...
      <View style={styles.table}>
        ...
        <View style={[styles.tableRow, styles.rowEven]}>
          ...
          <Text style={styles.tableCell}>12</Text>
          <Text style={styles.tableCell}>130.0</Text>
          <Text style={styles.tableCell}>0.0</Text>
          <Text style={styles.tableCell}>15.6</Text>
          <Text style={styles.tableCell}>15.6</Text>
        </View>

        <View style={[styles.tableRow, styles.rowOdd]}>
          <Text style={[styles.tableCell, styles.cellNombre]}>Huevo (clara extra)</Text>
          <Text style={styles.tableCell}>0</Text>
          <Text style={styles.tableCell}>12</Text>
          <Text style={styles.tableCell}>12</Text>
        ...
        <View style={[styles.tableRow, styles.rowEven]}>
          ...
          <Text style={styles.tableCell}>18.0</Text>
        ...
        <View style={[styles.tableRow, styles.tableHeader]}>
          ...
          <Text style={styles.tableCell}></Text>
          <Text style={styles.tableCell}>18.0</Text>
          <Text style={styles.tableCell}>32.8</Text>
          <Text style={styles.tableCell}>27.3</Text>
        </View>

        <View style={[styles.tableRow, styles.tableHeader]}>
          <Text style={[styles.tableCell, styles.cellNombre]}>Kcal</Text>
          <Text style={styles.tableCell}>72</Text>
          <Text style={styles.tableCell}>131</Text>
          <Text style={styles.tableCell}>246</Text>
          <Text style={styles.tableCell}>449</Text>
          <Text style={styles.tableCell}></Text>
          <Text style={styles.tableCell}></Text>
          <Text style={styles.tableCell}></Text>
        </View>
