...
export default function HomeScreen() {
  ...
  const handlePress = (screen: MealScreens) => {
    switch (screen) {
      case 'Desayuno': navigation.navigate('Desayuno', { mealType: 'Desayuno' }); break;
      case 'Almuerzo': navigation.navigate('Almuerzo', { mealType: 'Almuerzo' }); break;
      case 'Merienda': navigation.navigate('Merienda', { mealType: 'Merienda' }); break;
      case 'Cena': navigation.navigate('Cena', { mealType: 'Cena' }); break;
    }
  };
  ...
  let greeting = '';
  let animationSource: any = sunAnimation; // default
  let emoji = '';
    ...
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
      ...
      {meals.map((meal, index) => (
        <AnimatedCard
          ...
          image={meal.image as unknown as string} // Mantiene tus imágenes locales de cards
